...
const ListCard = ({children, inFlow}) => {
  return (
    <div className="list-card text-slate-600 bg-slate-100 font-normal text-sm md:text-lg text-left w-[95%] lg:w-3/5 mx-auto my-2 md:my-3 py-4 px-3 lg:px-6 rounded-2xl box-border grotesk">
